                    ...
                    <tbody>
                      ...
                      <tr>
                        <th scope="row">{{ $loop->iteration }}</th>
                          <td>{{ $active_loan->user->lastname }}</td> 
                          <td>{{ $active_loan->user->firstname }}</td> 
                          <td>{{ $active_loan->user->email }}</td> 
                          <td>{{ $active_loan->disbursement_date }}</td> 
