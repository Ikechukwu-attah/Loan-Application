								...
								<div class="main-menu">
									...
									<nav>
										<ul class="custom">
                                            ...
                                            <li class="menu-item  "> <a href= "{{ route('sign-in') }}" class="text-custom-white">Login</a>
											</li>
                                            <li class="menu-item  "> <a href="{{ route('sign-up') }}" class="text-custom-white">Register</a>
											</li>
										</ul>
									</nav>
									<div class="right-side">
